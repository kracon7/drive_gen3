...
class ArmControllerDemo:
	...
	def main(self, args):
		...
		self.send_cartesian_pose_abs([float(x), float(y), float(z)],
					[float(ex), float(ey), float(ez)],sleep_time=10)
		#*******************************************************************************
...
if __name__ == "__main__":
	'''
	move robot tool frame to given pose 
	example: python move_to.py x y z ex ey ez
	'''
